...
//    }
    ...
    private static ArrayList<String> readPartsFromFile(String fileName) throws FileNotFoundException {
    	// An array list of parts to hold the parameters of our parts
        ArrayList<String> parts = new ArrayList<>();
        // rewrite so the File object is being intialized in a try block
        ...
        while(reader.hasNextLine())
        {
        	...
        	// use the , character to distinguish between whats in the file
